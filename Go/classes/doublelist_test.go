...
func checkHeadTail[T comparable](t *testing.T, list *DoubleList[T], headVal, tailVal T) {
	t.Helper()
...
func TestFileIO_TextDL(t *testing.T) {
	list := NewDoubleList[int]()
	list.LPushBack(10)
	list.LPushBack(20)
...
func TestFileIO_BinaryDL(t *testing.T) {
	list := NewDoubleList[float64]()
	list.LPushBack(1.1)
	list.LPushBack(2.2)
